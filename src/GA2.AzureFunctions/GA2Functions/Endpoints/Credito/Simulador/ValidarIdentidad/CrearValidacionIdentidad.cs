...
{
    /// <summary>
    /// Crear validacion identidad
    /// </summary>
    /// <author>Nicolas Florez Sarrazola</author>
    /// <date>02/08/2021</date>
    public class CrearValidacionIdentidad
    {
        /// <summary>
        /// Business Logic
        /// </summary>
        ...
        [Function("CrearValidacionIdentidad")]
        public async Task<Response<ValidacionIdentidadDto>> Run([HttpTrigger(AuthorizationLevel.User, "post", Route = "crearValidacionIdentidad")] HttpRequestData req, FunctionContext executionContext)
        {
            ...
            return await _identidadBusinessLogic.CreateValidacionIdentidad(request);
        }
    }
}
