...
{
    /// <summary>
    /// Envia Subsancion Actividad Tramite
    /// </summary>
    ...
    public class EnviaSubsancionActividadTramite
    {
        ...
        public EnviaSubsancionActividadTramite(ICreditoBusinessLogic creditoBusinessLogic, ITokenClaims tokenClaims)
        {
            _creditoBusinessLogic = creditoBusinessLogic;
            _tokenClaims = tokenClaims;
        }

        [Function("EnviaSubsancionActividadTramite")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "post", Route = "enviaSubsancionActividadTramite")] HttpRequestData req, FunctionContext executionContext)
        {
            ...
            var result = await _creditoBusinessLogic.EnviaSubsancionActividadTramite(login);
