...
namespace GA2Functions.Endpoints.Credito.Simulador.Tramite
{
    ...
    public class ApruebaActividadTramite
    {
        /// <summary>
        /// Business Logic
        /// </summary>
        ...
        public ApruebaActividadTramite(ICreditoBusinessLogic creditoBusinessLogic, ITokenClaims tokenClaims)
        {
            _creditoBusinessLogic = creditoBusinessLogic;
            _tokenClaims = tokenClaims;
        }

        [Function("ApruebaActividadTramite")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "post", Route = "apruebaActividadTramite")] HttpRequestData req, FunctionContext executionContext)
        {
