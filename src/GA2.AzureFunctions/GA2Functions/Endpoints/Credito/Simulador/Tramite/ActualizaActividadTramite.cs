...
{
    /// <summary>
    /// Actualiza la actividad del tramite
    /// </summary>
    /// <author>Nicolas Florez Sarrazola</author>
    /// <date>02/08/2021</date>
    public class ActualizaActividadTramite
    {
        /// <summary>
        /// Business Logic
        /// </summary>
        ...
        public ActualizaActividadTramite(ICreditoBusinessLogic creditoBusinessLogic, ITokenClaims tokenClaims)
        {
            _creditoBusinessLogic = creditoBusinessLogic;
            _tokenClaims = tokenClaims;
        }

        [Function("ActualizaActividadTramite")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "post", Route = "actualizaActividadTramite")] HttpRequestData req, FunctionContext executionContext)
        {
            ...
            var result = await _creditoBusinessLogic.ActualizaActividadTramite(login);
