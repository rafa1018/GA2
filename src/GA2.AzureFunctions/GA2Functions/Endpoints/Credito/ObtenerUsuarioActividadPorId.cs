...
namespace GA2Functions.Endpoints.Credito
{
    ...
    public class ObtenerUsuarioActividadPorId
    {
        ...
        public ObtenerUsuarioActividadPorId(ICreditoBusinessLogic creditoBusinessLogic, ITokenClaims tokenClaims)
        {
            _creditoBusinessLogic = creditoBusinessLogic;
            _tokenClaims = tokenClaims;
        }

        [Function("ObtenerUsuarioActividadPorId")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "get", Route = "obtenerUsuarioActividadPorId/{id}")]
            HttpRequestData req, string id, FunctionContext executionContext)
        {
            ...
            var user = claims;
            var result = await _creditoBusinessLogic.ObtenerUsuarioActividadPorId(id);
