...
namespace BUAFunctions.Endpoints.UsersEndpoints
{
    class ObtenerUsuarios
    {
        ...
        public ObtenerUsuarios(IUsersBusinessLogic usersBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "get", Route = "users")] HttpRequestData req,
            FunctionContext executionContext)
        {
            ...
            await response.WriteAsJsonAsync<Response<IEnumerable<UsuarioDto>>>(result);
