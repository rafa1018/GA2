...
{
    public class EliminarTareaPorId
    {
        private readonly ITareaBusinessLogic _tareaBusinessLogic;
        private readonly ITokenClaims _tokenClaims;

        public EliminarTareaPorId(ITareaBusinessLogic tareaBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "delete", Route = "bpm/EliminarTareaPorId/{tareaId}")] HttpRequestData req,
            string tareaId,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("BpmEndpoints - EliminarTareaPorId");
            ...
            var result = await _tareaBusinessLogic.EliminarTareasPorId(tareaDtoId);
