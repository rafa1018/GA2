...
namespace GA2Functions.Endpoints.Bpm.Tarea
{
    public class CrearTarea
    {
        ...
        public CrearTarea(ITareaBusinessLogic tareaBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        [Function("CrearTarea")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "post", Route = "bpm/CrearTarea")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("BpmEndpoints - CrearTarea");
            ...
            var result = await _tareaBusinessLogic.CrearTarea(tareaDto);
