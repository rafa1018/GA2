...
namespace GA2Functions.Endpoints.Bpm.Proceso
{
    public class ActualizarProceso
    {
        ...
        public ActualizarProceso(IProcesoBusinessLogic procesoBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "put", Route = "bpm/ActualizarProceso")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("BpmEndpoints - ActualizarProceso");
            ...
            var result = await _procesoBusinessLogic.ActualizarProceso(procesoDto);
