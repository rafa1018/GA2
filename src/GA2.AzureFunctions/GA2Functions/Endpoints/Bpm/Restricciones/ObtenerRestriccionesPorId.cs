...
{
    public class ObtenerRestriccionesPorId
    {
        private readonly IRestriccionesBusinessLogic _restriccionesBusinessLogic;
        private readonly ITokenClaims _tokenClaims;

        public ObtenerRestriccionesPorId(IRestriccionesBusinessLogic restriccionesBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        [Function("ObtenerRestriccionesPorId")]
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "bpm/ObtenerRestriccionesPorId/{restriccionesId}")] HttpRequestData req,
            string restriccionesId,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("BpmEndpoints - ObtenerRestriccionesPorId");
            ...
            var result = await _restriccionesBusinessLogic.ObtenerRestriccionesPorId(restriccionesDtoId);
