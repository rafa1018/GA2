...
{
    /// <summary>
    /// Endpoint catalogo estado actividad
    /// </summary>
    /// <author>Oscar Julian Rojas</author>
    /// <date>11/08/2021</date>
    public class ObtenerEstadoActividad
    {
        /// <summary>
        /// Services
        /// </summary>
        ...
        /// <param name="tokenClaims">Token Services</param>
        /// <author>Cristian Gonzalez</author>
        /// <date>18/05/2021</date>
        public ObtenerEstadoActividad(ICatalogosBusinessLogic catalogsBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "obtenerEstadoActividad")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("CatalogoEndpoints - obtenerEstadoActividad");
            ...
            var result = await _catalogsBusinessLogic.ObtenerEstadoActividad();
