...
namespace GA2Functions.Endpoints.CatalogoEnpoints
{
    class ObtenerTiposCorreo
    {
        ...
        public ObtenerTiposCorreo(ICatalogosBusinessLogic catalogsBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        [Function("ObtenerTiposCorreo")]
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "obtenerTiposCorreos")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("CatalogoEndpoints - obtenerTiposCorreos");
            ...
            var result =  await _catalogsBusinessLogic.ObtenerTiposCorreo();
