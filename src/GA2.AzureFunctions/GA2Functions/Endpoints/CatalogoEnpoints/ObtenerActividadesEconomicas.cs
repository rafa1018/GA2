...
namespace GA2.GA2Functions.Endpoints.CatalogoEnpoints
{
    ...
    /// </summary>
    public class ObtenerActividadesEconomicas
    {
        /// <summary>
        /// Servicios
        /// </summary>
        ...
        public ObtenerActividadesEconomicas(ICatalogosBusinessLogic catalogsBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "obtenerActividadesEconomicas")] HttpRequestData req,
            FunctionContext executionContext)
        {
            ...
            var result = await _catalogsBusinessLogic.ObtenerActividadesEconomicas();
