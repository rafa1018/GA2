...
{
    public class ObtenerTipoCredito
    {
        ...
        public ObtenerTipoCredito(ICatalogosBusinessLogic catalogsBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        [Function("ObtenerTipoCredito")]
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "obtenertipocredito")] HttpRequestData req,
            FunctionContext executionContext)
        {
            ...
            var result =  await _catalogsBusinessLogic.ObtenerTipoCredito();
