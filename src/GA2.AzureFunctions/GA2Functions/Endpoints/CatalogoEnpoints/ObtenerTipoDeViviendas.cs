...
{
    public class ObtenerTipoDeViviendas
    {
        ...
        public ObtenerTipoDeViviendas(ICatalogosBusinessLogic catalogsBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        [Function("ObtenerTipoDeViviendas")]
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "obtenertipodeviviendas")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("CatalogoEndpoints - obtenertipodeviviendas");
            ...
            var result = await _catalogsBusinessLogic.ObtenerTiposDeVivienda();
