...
namespace GA2.GA2Functions.Endpoints.CatalogoEnpoints
{
    ...
    /// </summary>
    public class ObtenerTiposDireccion
    {
        /// <summary>
        /// Servicios
        /// </summary>
        ...
        public ObtenerTiposDireccion(ICatalogosBusinessLogic catalogsBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        [Function("ObtenerTiposDireccion")]
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "ObtenerTiposDireccion")] HttpRequestData req,
            FunctionContext executionContext)
        {
            ...
            var result = await _catalogsBusinessLogic.ObtenerTiposDireccion();
