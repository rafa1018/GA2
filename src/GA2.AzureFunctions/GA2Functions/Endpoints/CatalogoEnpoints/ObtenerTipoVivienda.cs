...
namespace GA2Functions.Endpoints.CatalogoEnpoints
{
    public class ObtenerTipoVivienda
    {
        ...
        public ObtenerTipoVivienda(ICatalogosBusinessLogic catalogsBusinessLogic,ITokenClaims tokenClaims)
        {
        ...
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "obtenerTiVivienda")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("CatalogoEndpoints - obtenerTiVivienda");
            ...
            var result = await _catalogsBusinessLogic.ObtenerTipoVivienda();
