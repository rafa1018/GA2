...
namespace GA2Functions.Endpoints.CatalogoEnpoints
{
    public class ObtenerPaises
    {
        ...
        public ObtenerPaises(ICatalogosBusinessLogic catalogsBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.User, "get", Route = "obtenerpaises")] HttpRequestData req,
            FunctionContext executionContext)
        {
            ...
            var result =  await _catalogsBusinessLogic.ObtenerPaises();
