...
{
    /// <summary>
    /// Endpoint actualizar tipo vivienda
    /// </summary>
    ...
    public class ActualizarTipoVivienda
    {
        ...
        public ActualizarTipoVivienda(ICatalogosBusinessLogic tipoviviendaBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        /// <summary>
        /// Endpoint Actualizar tipo viviendo
        /// </summary>
        /// <param name="req">UsuarioDto</param>
        /// <param name="executionContext">context functions</param>
        /// <returns>TipoViviendaDto</returns>
        [Function("ActualizarTipoVivienda")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "patch", Route = "actualizartipovivienda")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("CatalogoEndpoints - ActualizarTipoVivienda");
            ...
            var result = await _tipoviviendaBusinessLogic.ActualizarTipoVivienda(tipoVivienda);
