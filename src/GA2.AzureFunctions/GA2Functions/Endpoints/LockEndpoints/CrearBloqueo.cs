...
namespace GA2Functions.Endpoints.LockEndpoints
{
    public class CrearBloqueo
    {
        ...
        public CrearBloqueo(IBloqueoBusinessLogic lockBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        /// <summary>
        /// Endpoint CrearBloqueo
        /// </summary>
        /// <param name="req">UsuarioDto</param>
        /// <param name="executionContext">context functions</param>
        /// <returns>UsuarioDto</returns>
        [Function("CrearBloqueo")]
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "post", Route = "bloqueo/CrearBloqueo")] HttpRequestData req,
            FunctionContext executionContext)
        {
            var logger = executionContext.GetLogger("LockEnpoints - bloqueo/CrearBloqueo");
