...
namespace BUAFunctions.Endpoints.RolPorUsuarioEndpoint
{
    public class CrearFormulario
    {
        ...
        public CrearFormulario(IFormularioBusinessLogic formularioBusinessLogic, ITokenClaims tokenClaims)
        {
        ...
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.User, "post", Route = "roles/formulariocrear")] HttpRequestData req,
            FunctionContext executionContext)
        {
            ...
            var result = await _formularioBusinessLogic.CrearFormulario(login);
