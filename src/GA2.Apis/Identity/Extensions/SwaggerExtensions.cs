...
namespace GA2.Apis.Identity.Extensions
{
    ...
    internal static class SwaggerExtensions
    {
        ...
        internal static OpenApiInfo GetOpenApiInfo(IConfiguration configuration)
        {
            ...
            {
                Title = string.Format($"{IdentityConstants.ApiName} API"),
                Version = configuration["VersionApi"],
                Description = IdentityConstants.GetOpenApiInfoDescription
            };
        }
        ...
        internal static OpenApiSecurityScheme GetOpenApiSecurityScheme(IConfiguration configuration)
        {
            ...
            {
                Description = IdentityConstants.GetOpenApiSecuritySchemeDescription,
                Name = IdentityConstants.GetOpenApiSecuritySchemeName,
        ...
        internal static IApplicationBuilder UseSwaggerDocumentation(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "GA2.Identity API");
            });
            return app;
        }
    }
