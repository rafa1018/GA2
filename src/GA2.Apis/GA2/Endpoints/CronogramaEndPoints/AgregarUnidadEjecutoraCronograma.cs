...
namespace GA2.Apis.GA2.EndPoints
{
    ...
    [Authorize]
    public class AgregarUnidadEjecutoraCronograma :
         BaseAsyncEndpoint.WithRequest<CronogramaDto>.WithResponse<Response<IEnumerable<CronogramaDto>>>
    {
        ...
        /// <date>11/05/2021</date>
        public AgregarUnidadEjecutoraCronograma(ICronogramaNovedadesBusinessLogic cronogramaNovedadesBusinessLogic)
        {
        ...
        [HttpPost("api/cronograma/AgregarUnidadEjecutoraCronograma")]
        ...
        public async override Task<ActionResult<Response<IEnumerable<CronogramaDto>>>> HandleAsync(CronogramaDto request, CancellationToken cancellationToken = default)
        {
            return await this._cronogramaBusinessLogic.AgregarUnidadEjecutoraCronograma(request);
        }
    }
}
