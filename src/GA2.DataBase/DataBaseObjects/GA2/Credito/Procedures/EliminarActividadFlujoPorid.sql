USE [GA2]
GO
/****** Object:  StoredProcedure [dbo].[EliminarActividadFlujoPorid]    Script Date: 7/07/2021 12:33:40 a. m. ******/
SET ANSI_NULLS ON
GO
...
-- Description:	<Eliminar Actividad flujo por id>
-- =============================================
CREATE PROCEDURE [dbo].[EliminarActividadFlujoPorid]
	@AFL_ID int
AS
BEGIN
UPDATE [AFL_ACTIVIDAD_FLUJO]
SET
	AFL_ESTADO=0      
WHERE
	AFL_ID=@AFL_ID
